...
{% figure "_NDI Kosovo: الصورة_", "right" %}
...
{% figure "في 28 آب/أغسطس 2019، استدعي النائب السابق لرئيس مجلس إدارة ائتلاف الانتخابات النظيفة والنزيهة 2.0 للإدلاء بشهادته بعد رفعه تقريراً إلى الشرطة. _BERSIH 2.0: الصورة_." %}
