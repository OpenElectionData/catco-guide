...
{% figure "_NDI Photo_", "left" %}
![people gather around computer ](/_assets/images/NDI_STOs-1.jpg 'NDI Photo')
{% endfigure %}
...
{% figure "_Photo: NDI Peru_", "left" %}
![Media covers an event ](/_assets/images/NDI_peru_3.jpg 'NDI Peru ')
{% endfigure %}
...
{% figure "_Photo: PACE_", "right" %}
![PACE Communications officer talking with journalists interested in elections](/_assets/images/pace_5-1.jpg 'PACE speaks with Media ')
{% endfigure %}
...
{% figure "_Photo: PACE_", "center" %}
![PACE representative gives press statement.](/\_assets/images/Preliminary finding press conference of 2017 By-Elections (1).JPG "PACE")
{% endfigure %}
...
{% figure "_Photo: YIAGA Africa_", "left" %}
![Youth attend a local town hall](/_assets/images/yiaga_1-1.jpg 'YIAGA Africa works to increase youth participation ')
{% endfigure %}
...
{% figure "_Photo: PACE_", "center" %}
![PACE representatives conduct public outreach.](/_assets/images/pace_2.jpg 'PACE')
{% endfigure %}
