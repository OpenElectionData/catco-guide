...
{% figure "Chart adapted from Ed Grefe's lectures as an adjunct professor at George Washington University.", "center" %}

![](/_assets/images/bell_chart_eng.png)
...
| - Existing members (aka our "friends") and their social networks                                                        | Strategy 3: Use our email list to encourage peer-to-peer social sharing.                                               |
...
{% textarea label="Target Audience 2", id="2a", size="Small", button="false" %}
{% textarea label="Detailed Profile 2", id="2b", size="Small", button="false" %}
{% textarea label="Target Audience 3", id="3a", size="Small", button="false" %}
{% textarea label="Detailed Profile 3", id="3b", size="Small", button="false" %}
{% textarea label="Target Audience 4", id="4a", size="Small", button="false" %}
{% textarea label="Detailed Profile 4", id="4b", size="Small", button="false" %}
