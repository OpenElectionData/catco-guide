...
{% callout title="Придерживайтесь своих стандартов" %}

“The losers of the election are always going to accuse you of being an agent,” said Iryna Shvets, program manager for [OPORA](https://www.oporaua.org/en). “Always have to stick to the standards -- the standards for independent observations, and the values of your organization.” She advises making those standards and values open and available to the public, so anyone can easily find and understand your methods and purpose. This can help preempt or mitigate those accusations. «Те, кто проигрывает выборы, всегда будут вас обвинять в том, что вы агент, – говорит Ирина Швец, Менеджер программ [ОПОРЫ](https://www.oporaua.org/en). – \[Вы\]... всегда должны придерживаться стандартов – стандартов независимого наблюдения и ценностных установок вашей организации». Она рекомендует сделать эти стандарты и ценностные установки открытыми для доступа публики, чтобы любой человек мог без труда найти и понять вашу методологию и задачу. Это может помочь предотвратить или уменьшить обвинения.
