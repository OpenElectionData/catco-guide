...
<table> <thead> <tr> <th>Цель</th> <th>Основная идея, которую вы хотите передать</th> <th>Целевая аудитория</th> <th>Содержание месседжа для целевой аудитории</th> <th>Метод коммуникации</th> <th>Контрольные показатели</th> </tr> </thead> <tbody> <tr> <td rowspan="4">Повысить осведомленность населения о том, что из себя представляет параллельный подсчет голосов (ППГ) путем привлечения 10 000 посетителей на наш веб-сайт и за три недели до выборов уже иметь в среднем по 100 000 посещений на каждой из наших страниц в социальных сетях.</td> <td rowspan="4">ППГ позволяет дать независимую оценку достоверности официальных результатов голосования, потому что каждый голос должен быть услышан и учтен.</td> <td>Journalists who write about elections. Журналисты, которые пишут о выборах</td> <td>A PVT is a statistically rigorous and internationally accepted standard of gauging the accuracy or fraudulence of an election. The results of the PVT will help tell the story of the upcoming election by providing another data set against which to check election results. ППГ – это статистически точный, международно признанный стандарт оценки достоверности или фальсификаций официальных результатов голосования. Результаты ППГ помогут рассказать о предстоящих выборах и предоставят данные, с которыми можно будет сопоставлять официальные результаты голосования.</td> <td>- Email press releases & press conferences Электронные пресс-релизы и пресс-конференции<br><br>- Materials on website Материалы на веб-сайте<br><br>- One-on-one phone interviews & quarterly conference calls Личные телефонные интервью и ежеквартальные конференц-звонки<br><br>- Twitter<br><br>- Whatsapp group Группа в WhatsApp</td> <td>- 30 percent open rate and 10 percent click-through rate for emails, 50 journalists attend conference and 20 write about it Коэффициент просмотра электронных сообщений – 30% и коэффициент переходов по ссылке – 10%; 50 журналистов посетят конференцию и 20 из них напишут о ней<br><br>- Page is visited 50 times per quarter Число посещений страницы – 50 раз в квартал<br><br>- Attendance of 12 journalists per call. 12 журналистов принимают участие в каждом из звонков<br><br>- At least one journalist DMs with us on Twitter regularly По крайней мере один журналист регулярно отправляет нам личные сообщения в Twitter<br><br>- Journalist WhatsApp group membership is 100 or more В группе WhatsApp состоит 100 и более журналистов </td> </tr> <tr> <td>Members of the party in power Члены правящей партии</td> <td>A PVT verifies fair and accurate election results. Win or lose, great leaders respect the will of the people, when every vote is counted and every voice is heard. ППГ позволяет провести проверку объективности и достоверности результатов выборов. После того, как каждый голос будет услышан и учтен, независимо от того, кто победит, настоящие лидеры будут уважать волю народа.</td> <td>- One-on-one outreach to party leadership Персональная коммуникация с руководством партии<br><br>-- Ads & op-eds in the The Daily Journal, The Weekly Magazine, and The Radio Newshour Реклама и заметки в колонках журналов «Дейли джорнал» и «Уикли мэгэзин», а также, на радио в новостях<br><br>-- Facebook ads Реклама на Facebook</td> <td>-2 meetings per quarter Две встречи в квартал<br><br>-- Once a week placementsРеклама и заметки размещаются 1 раз в неделю<br><br>-- Click through rate to call to action is 40 percent Коэффициент переходов по ссылке с призывом к действию составляет 40%</td> </tr> <tr> <td>Members of the opposition party Члены оппозиционной партии</td> <td>A PVT verifies that true results are known and dissuades fraud, because every vote should be counted and every voice should heard. ППГ помогает обнародовать реальные результаты голосования, и предотвращает  фальсификации, потому что каждый голос должен быть услышан и учтен.</td> <td>- One-on-one outreach to the party leadership Персональная коммуникация с руководством партии<br><br>- Ads in the Opposition Weekly Реклама в «Оппозишн Уикли»<br><br>- Blast emails Массовая электронная рассылка</td> <td>- 2 meetings per quarter Две встречи в квартал<br><br>- Weekly placementsМассовая электронная рассылка делается еженедельно<br><br>- List is 250 people with an open rate of 25 percent Массовая рассылка 250-ти получателям с коэффициентом просмотра сообщений 25%</td> </tr> <tr> <td>Young men ages 16-26 Мужчины от 16 до 26 лет</td> <td>A PVT is a way of verifying that your voice is heard in these elections. ППГ дает возможность убедиться, что ваш голос был услышан на этих выборах.</td> <td>- Facebook posts and videos Посты и видео на Facebook<br><br>- Paid Facebook promotion Платная услуга продвижения на Facebook</td> <td>- 25,000 reach from this demographic per week; 10 percent engagement rate and average video watch is 15 seconds Охват в этой демографической группе – 25 000 пользователей в неделю; коэффициент вовлеченности – 10% и средняя продолжительность просмотра видео – 15 секунд<br><br>- 25,000 reach from these ads and 5 percent conversion to page likes Охват пользователей в результате рекламы – 25 000; 5 %«лайкают» наши страницы</td> </tr> </tbody> </table>